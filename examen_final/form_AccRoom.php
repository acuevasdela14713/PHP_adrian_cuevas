...
//emmagatzemar en una variable els serveis de restauració seleccionats
  ...
  if (isset($type)){
    //cridar a la funcio typePriceCalculation amb els parametres requerits
    $typePrice = typePriceCalculation($type);
  }
  ...
  if (isset($views) and $views != null){
    //cridar a la funcio viewsPriceCalculation amb els parametres requerits
  ...
  //calcular del preu del segons els serveis seleccionats de l'habitació
    if (isset($foodServices) and $foodServices != null){
      //cridar a la funcio foodServicesPriceCalculation amb els parametres requerits
